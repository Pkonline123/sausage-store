...
public class SausageApplication {
    ...
    CommandLineRunner runner(ProductService productService) {
        return args -> {
            ...
            productService.save(new Product(1L, "Сливочная", 320.00, "https://storage.yandexcloud.net/std-013-20-images/6.jpg"));
            productService.save(new Product(2L, "Особая", 179.00, "https://storage.yandexcloud.net/std-013-20-images/5.jpg"));
