...
public class SausageApplication {
    ...
    CommandLineRunner runner(ProductService productService) {
        return args -> {
            ...
            productService.save(new Product(1L, "Сливочная", 320.00, "https://console.cloud.yandex.ru/folders/b1g2m7136g982ot032pf/storage/buckets/std-013-20-images?key=6.jpg"));
            productService.save(new Product(2L, "Особая", 179.00, "https://console.cloud.yandex.ru/folders/b1g2m7136g982ot032pf/storage/buckets/std-013-20-images?key=5.jpg"));
            productService.save(new Product(3L, "Молочная", 225.00, "https://console.cloud.yandex.ru/folders/b1g2m7136g982ot032pf/storage/buckets/std-013-20-images?key=4.jpg"));
            productService.save(new Product(4L, "Нюренбергская", 315.00, "https://console.cloud.yandex.ru/folders/b1g2m7136g982ot032pf/storage/buckets/std-013-20-images?key=3.jpg"));
            productService.save(new Product(5L, "Мюнхенская", 330.00, "https://console.cloud.yandex.ru/folders/b1g2m7136g982ot032pf/storage/buckets/std-013-20-images?key=2.jpg"));
            productService.save(new Product(6L, "Американская", 189.00, "https://console.cloud.yandex.ru/folders/b1g2m7136g982ot032pf/storage/buckets/std-013-20-images?key=1.jpg"))
        };
    }
}
